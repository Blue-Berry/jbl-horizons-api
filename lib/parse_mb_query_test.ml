...
*******************************************************************************
 Multiple major-bodies match string "*"
  ...
  -------  ---------------------------------- -----------  -------------------
    ...
    85052  2021N1
     ...
     3015  EM-L5                                           Lagrange
       ...
       -3  Mars Orbiter Mission (spacecraft)  2013-060A    MOM Mangalyaan
       -5  Planet-C (spacecraft)              2010-020D    VCO Akatsuki
       -6  Pioneer 6 (spacecraft)             1965-105A
       -8  Wind (spacecraft)                  1994-071A
      -12  LADEE (spacecraft)                 2013-047A
      -18  LCROSS Shepherd (spacecraft)       2009-031B    SSC
   -18900  LCROSS Centaur Impactor (spacecraft2009-031B
      -20  Pioneer 8 (spacecraft)             1967-123A
      -21  SOHO (spacecraft)                  1995-065A
      -23  Pioneer 10 (spacecraft)            1972-012A
      -24  Pioneer 11 (spacecraft)            1973-019A
      -25  Lunar Prospector (LP) (spacecraft) 1998-001A
      -28  JUICE (spacecraft)                 2023-053A
      -29  Stardust (bus) (spacecraft)        1999-003A    NExT
   -29900  Stardust (SRC) (spacecraft)        1999-003D
      -30  Deep Space 1 (spacecraft)          1998-061A    DS1 DS-1
      -31  Voyager 1 (spacecraft)             1977-084A
      -32  Voyager 2 (spacecraft)             1977-076A
      -33  NEOS (spacecraft)                               NEO Surveyor
      -37  Hayabusa 2 (spacecraft)            2014-076K
      -39  Ouna (spacecraft)                  2007-039C
      -40  Clementine (spacecraft)            1994-004A    DSPSE
      -41  Mars Express (spacecraft)          2003-022A    MEX
      -43  IMAP (spacecraft)
      -47  Genesis (bus) (spacecraft)         2001-034A
      -48  Hubble Space Telescope (spacecraft)1990-037B    HST
      -49  Lucy (spacecraft)                  2021-093A
   -47900  Genesis (SRC) (spacecraft)         2001-034D
      -53  Mars Odyssey (spacecraft)          2001-013A
     -530  Mars Pathfinder (spacecraft)       1996-068A    MPF
      -55  Ulysses (spacecraft)               1990-090B
      -61  Juno (spacecraft)                  2011-040A
      -62  EMM (spacecraft)                   2020-047A    Emirates Hope
      -64  OSIRIS-REx (spacecraft)            2016-055A    OSIRIS-APX ORX APEX
      -65  MarCO-A (spacecraft)               2018-042B    Wall-E
      -66  MarCO-B (spacecraft)               2018-042C    Eva
      -70  Deep Impact IMPACTOR (spacecraft)  2005-001D
      -74  Mars Reconnaissance Orbiter (spacec2005-029A    MRO
      -75  OMOTENASHI (spacecraft)            2022-156D
      -76  Mars Science Laboratory (spacecraft2011-070A    Curiosity MSL
   -74900  MRO Centaur Stage (spacecraft)     2005-029B
      -77  Galileo (spacecraft)               1989-084B
      -78  DSCOVR (spacecraft)                2015-007A    Triana
      -79  Spitzer Space Telescope (spacecraft2003-038A    SST SIRTF
      -82  Cassini (spacecraft)               1997-061A
      -84  Phoenix (spacecraft)               2007-034A
      -85  LRO (spacecraft)                   2009-031A
      -86  Chandrayaan-1 (spacecraft)         2008-052A    CH1 CH-1
      -91  Hera (spacecraft)                  2024-180A
      -92  ACE (spacecraft)                   1997-045A    Advanced Composition
      -93  NEAR Shoemaker (spacecraft)        1996-008A
      -95  TESS (spacecraft)                  2018-038A
      -96  Parker Solar Probe (spacecraft)    2018-065A    SPP PSP
      -98  New Horizons (spacecraft)          2006-001A    NH New_Horizons
     -101  EQUULEUS (spacecraft)              2022-156E
     -111  ICE (spacecraft)                   1978-079A    ISEE-3
     -121  BepiColombo (Spacecraft)           2018-080A    MPO MMO
     -125  ICPS (Spacecraft)                  2022-156B
     -130  Hayabusa (spacecraft)              2003-019A    Muses-C
     -135  DART (spacecraft)                  2021-110A
     -140  Deep Impact Flyby - EPOXI (spacecra2005-001A
     -143  ExoMars16 TGO (spacecraft)         2016-017A
     -144  Solar Orbiter (spacecraft)         2020-010A    Solo
     -150  Cassini Huygens (spacecraft)       1997-061C
     -151  Chandra Observatory (spacecraft)   1999-040B
     -152  Chandrayaan-2 (ORBITER) (spacecraft2019-042A    CH2 CH-2
     -153  Chandrayaan-2 (LANDER) (spacecraft)2019-042A    CH2 CH-2
     -155  Danuri (spacecraft)                2022-094A    KPLO
     -156  Aditya-L1                          2023-132A
     -158  Chandrayaan-3 (LANDER spacecraft)  2023-098A    CH-3 CH3 Vikram
     -159  Europa Clipper (spacecraft)        2024-182A
     -163  WISE (spacecraft)                  2009-071A    NEOWISE
     -164  Lunar Flashlight (spacecraft)      2022-168B    LFL
     -165  WMAP (spacecraft)                  2001-027A
     -168  Mars2020 (spacecraft)              2020-052A    Ingenuity Perseveran
     -169  Chandrayaan-3P (ORBITER) (spacecraf2023-098A    CH-3P CH3P
     -170  James Webb Space Telescope (spacecr2021-130A    JWST
     -176  GRAIL-SS Second Stage (spacecraft) 2011-046C
     -177  GRAIL-A (spacecraft)               2011-046A    Ebb
     -178  Nozomi (spacecraft)                1998-041A    Planet-B
     -181  GRAIL-B (spacecraft)               2011-046B    Flow
     -182  NEA Scout (spacecraft)             2022-156H
     -189  InSight (spacecraft)               2018-042A
     -192  THEMIS-B (spacecraft)              2007-004B    ARTEMIS-P1
     -193  THEMIS-C (spacecraft)              2007-004C    ARTEMIS-P2
     -198  INTEGRAL (spacecraft)              2002-048A
     -202  MAVEN (spacecraft)                 2013-063A
     -203  Dawn (spacecraft)                  2007-043A
     -204  CONTOUR-A (SPACECRAFT FRAGMENT)    2002-034A
     -205  CONTOUR-B (SPACECRAFT FRAGMENT)    2002-034A
     -206  CONTOUR-C (SPACECRAFT FRAGMENT)    2002-034A
     -210  LICIACube (spacecraft)             2021-110C
     -211  Roman Space Telescope (spacecraft)              RST Nancy Grace
     -226  Rosetta (spacecraft)               2004-006A
     -227  Kepler (spacecraft)                2009-011A
     -234  STEREO-A (spacecraft)              2006-047A    AHEAD
     -235  STEREO-B (spacecraft)              2006-047B    BEHIND
  -234900  STEREO Third Stage (spacecraft)    2006-047C
     -236  MESSENGER (spacecraft)             2004-030A
     -240  SLIM (spacecraft)                  2023-137D
     -242  Lunar Trailblazer (spacecraft)     2025-038C    LTB
     -248  Venus Express (spacecraft)         2005-045A    VEX
     -253  Opportunity (spacecraft)           2003-032A    MER-B MER-1
     -254  Spirit (spacecraft)                2003-027A    MER-A MER-2
     -255  Psyche (spacecraft)                2023-157A
     -344  Galileo Probe (spacecraft)         1989-084E
     -486  Herschel Space Observatory (spacecr2009-026A
     -489  Planck Space Observatory (spacecraf2009-026B
     -490  Lucy Centaur RB Booster (spacecraft2021-093B
     -557  Spektr-R Observatory (spacecraft)  2011-037A
     -610  Juno Centaur Stage (spacecraft)    2011-040B
     -640  Infrared Space Observatory (spacecr1995-062A    ISO
     -680  Euclid (spacecraft)                2023-092A
     -760  MSL Centaur Stage (spacecraft)     2011-070B
     -997  NEOCP 6Q0B44E                                   B44E
     -998  NEOCP J002E3
    -1023  Artemis I (spacecraft)             2022-156A    Orion EM-1
    -1176  CAPSTONE (spacecraft)              2022-070A
   -40000  Clementine Extended (spacecraft)   1994-004A
   -64090  OSIRIS-REx SRC (spacecraft)
   -70007  BioSentinel (spacecraft)           2022-156F    BIOS
   -78000  Chang'e_5-T1_booster (spacecraft)  2014-065B    WE0913A
   -23230  ETS-6 (spacecraft)                 1994-056A    Kiku-6
  -399050  2015 PDC (simulation)
  -399080  Apollo 8 S-IVB (spacecraft)        1968-118B
  -399090  Apollo 9 S-IVB (spacecraft)        1969-018B
  -399100  Apollo 10 S-IVB (spacecraft)       1969-043B
  -399101  Apollo 10 LM (spacecraft)          1969-059C    Snoopy
  -399110  Apollo 11 S-IVB (spacecraft)       1969-059B
  -399120  Apollo 12 S-IVB (spacecraft)       1969-099B
  -100836  Vela-2A (spacecraft)               1964-040B
  ...
  -113631  SATCOM-C5 (spacecraft)             1982-105A    RCA-SATCOM-5
  ...
  -116292  COSMOS 1704 RB (spacecraft)        1985-110B    SL-8_RB
  ...
  -124720  HALCA (spacecraft)                 1997-005A    Muses-B Haruka VSOP
  -124786  GOES-10 (spacecraft)               1997-019A
  -125126  HGS-1 (spacecraft)                 1997-086A    Asisat-3 PAS-22
  ...
  -125994  TERRA (spacecraft)                 1999-068A    EOS-1
  ...
  -126639  AMC-8 (spacecraft)                 2000-081B    GE-8
  ...
  -127783  GALEX (spacecraft)                 2003-017A
  ...
  -132763  ICO_G-1 (spacecraft)               2008-016A    Echostar G1 DBSD
  ...
  -136134                                     2009-071C
  -136395  Solar Dynamics Observatory (spacecr2010-005A    SDO
  ...
  -139479  Gaia (spacecraft)                  2013-074A
  ...
  -140947  MEXSAT-2 Centaur RB (spacecraft)   2015-056B    MORELOS-3
  -141043  LISA Pathfinder (spacecraft)       2015-070A    LPF
  ...
  -143205  SpaceX Roadster (spacecraft)       2018-017A    Tesla Starman
  ...
  -161448  Cert-2 Centaur RB Booster          2024-179A    C43KHJ1
  -163182  SPHEREx (spacecraft)               2025-047E
  -165053  NISAR (spacecraft)                 2025-163A
  ...
  -937020  2024 PDC25a (simulation)                        PDC25a
...
-10001001  Odin (spacecraft)                  2025-038D
  1000012
 ...
 -9901491  Tianwen-1 (spacecraft)             2020-049A
...
-54054450  Surveyor-2 Centaur RB              1966-084B    2020 SO
   ...
   Number of matches =  773. Use ID# to make unique selection.
*******************************************************************************
|}
;;

let%expect_test "parse major bodies query results - first 10" =
  let bodies = Parse_mb_query.parse test_input in
  List.take bodies 10
  |> List.iter ~f:(fun body ->
    Printf.printf
      "ID: %d | Name: %s | Designation: %s | Aliases: %s\n"
      body.Parse_mb_query.id
      body.Parse_mb_query.name
      body.Parse_mb_query.designation
      body.Parse_mb_query.aliases);
  [%expect
    {|
    ID: 0 | Name: Solar System Barycenter | Designation:  | Aliases: SSB
    ID: 1 | Name: Mercury Barycenter | Designation:  | Aliases:
    ID: 2 | Name: Venus Barycenter | Designation:  | Aliases:
    ID: 3 | Name: Earth-Moon Barycenter | Designation:  | Aliases: EMB
    ID: 4 | Name: Mars Barycenter | Designation:  | Aliases:
    ID: 5 | Name: Jupiter Barycenter | Designation:  | Aliases:
    ID: 6 | Name: Saturn Barycenter | Designation:  | Aliases:
    ID: 7 | Name: Uranus Barycenter | Designation:  | Aliases:
    ID: 8 | Name: Neptune Barycenter | Designation:  | Aliases:
    ID: 9 | Name: Pluto Barycenter | Designation:  | Aliases:  |}]
;;
